...
Aufbau einer pilothaften Daten- und Reportingplattform für eine Bibliothek.
...
* Verwaltung des Bücherbestandes
* Stammdatenverwaltung der Kunden

Auswertung

* „Welche und wie viele Bücher haben welchen Status“?
* „Wie viele Bücher welcher Kategorien haben welchen Status?“
* „Wie stellt sich das Ausleihverhalten geografisch dar?“
* „Welche Bücher/Genres/… sind besonders beliebt?“
...
Fachlich korrekte Abbildung von

* Buchbestand
* Kundenbestand ink. Mitliedsbeiträge
* Leihen inkl. Versand, Mahnungen, Mahnungszahlungen
* Bewertungen

Erstellung von Reports basierend auf obigen Daten zu
* 
* 
